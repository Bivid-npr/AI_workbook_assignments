...
def cluster_and_visualise(datafile_name:str, K:int, feature_names:list):
   ...
   # ====> insert your code below here
    ...
    my_model = KMeans(n_clusters=K, n_init=10)
    my_model.fit(data)
    cluster_ids = my_model.predict(data)
    ...
    title = fig.suptitle(f"Visualisation of {K} clusters by BN2-PRADHAN", fontsize=16, y=0.925)
